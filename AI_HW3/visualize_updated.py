...
def visualize_3d(df, lin_reg_weights=[1,1,1], feat1=0, feat2=1, labels=2,
    ...
    Optional args:
      - x,y,zlim: axes boundaries. Detault to 0-1 normalized feature values.
    ...
    axes1 = np.arange(xlim[1], step=.05)  # age
    axes2 = np.arange(ylim[1], step=.05)  # weight
...
if __name__ == "__main__":
    ...
    # visualize_scatter(data, feat1=0, feat2=1, labels=2, weights=[-7.4741976071,-2.60850815401,60.4614857868],
    ...
    for index,row in df.iterrows():
      df.loc[index] = [(row[0]-5.21)/1.899,(row[1]-18.306)/6.117,row[2]]

    # print df

    visualize_3d(df, lin_reg_weights=[1.09646,0.12862,0.0014], feat1=0, feat2=1, labels=2,
                 xlim=(0, 1), ylim=(0, 1), zlim=(0, 3),
                 alpha=0.5, xlabel='age', ylabel='weight', zlabel='height',
